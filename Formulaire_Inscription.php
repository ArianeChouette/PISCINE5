    ...
    <form>
      <table>
        ...
        <tr>
          ...
          <td><input type="date" name="DateN" placeholder="Date de naissance" required></td>
        </tr>

        <!--Champs de l'adresse-->
        <tr>
          <td><label>Adresse</label></td>
          <td><input type="text" name="Numerodevoie" placeholder="N° de voie" required></td>

          <td><input type="text" name="Typedevoie" placeholder="Rue, Boulevard..." required></td>
          <td><input type="text" name="Complément" placeholder="Bâtiment, étage..." required></td>

          <td><input type="number" name="Codepostal" placeholder="Code postal" required></td>
        </tr>
